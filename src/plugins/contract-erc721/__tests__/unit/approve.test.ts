...
describe('contract-erc721 plugin - approve command (unit)', () => {
  ...
  test('calls ERC-721 approve successfully and returns expected output', async () => {
    ...
    const result = await contractErc721Approve(args);
  ...
  test('throws TransactionError when execute returns success false', async () => {
    ...
    await expect(contractErc721Approve(args)).rejects.toThrow(TransactionError);
    await expect(contractErc721Approve(args)).rejects.toThrow(
  ...
  test('propagates error when execute throws', async () => {
    ...
    await expect(contractErc721Approve(args)).rejects.toThrow('network error');
  });
  ...
  test('propagates error when contract not found', async () => {
    ...
    await expect(contractErc721Approve(args)).rejects.toThrow('not found');
  });
  ...
  test('throws NotFoundError when to has no evmAddress', async () => {
    ...
    await expect(contractErc721Approve(args)).rejects.toThrow(NotFoundError);
    await expect(contractErc721Approve(args)).rejects.toThrow(

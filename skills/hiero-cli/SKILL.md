...
| `eip712`            | EIP-712 typed data signing | `sign-ecdsa` typed data payload (outputs r, s, v + combined signature), `verify-ecdsa` signature and recover signer EVM address                                                                                                                                                         |
